...
export const SEARCH_COURSE_BY_TAG = 'SEARCH_COURSE_BY_TAG';
export const SEARCH_PRODUCT_BY_TAG = 'SEARCH_PRODUCT_BY_TAG';
export const SIDE_MENU_LINKS = 'SIDE_MENU_LINKS';
export const ORDER_DETAILS = 'ORDER_DETAILS';
export const ADDRESS = 'Address';
export const ADD_ADDRESS = 'AddAddress';
export const ADDRESSESS = 'Addressess';
export const COUPONS = 'Coupon';
export const SHIPPING = 'Shipping';
export const COURSE_COUPON =  'CourseCoupon';