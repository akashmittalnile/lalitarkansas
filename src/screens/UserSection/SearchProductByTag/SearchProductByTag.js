...
const SearchProductByTag = ({navigation, dispatch, route}) => {
  //variables
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={styles.container}>
        <MyHeader Title="Search Products" isBackButton />
        <ScrollView
...
export default connect(null, mapDispatchToProps)(SearchProductByTag);
