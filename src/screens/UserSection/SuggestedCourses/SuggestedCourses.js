...
import SuggestedFiltersModal from './components/SuggestedFiltersModal/SuggestedFiltersModal';
import {createThumbnail} from 'react-native-create-thumbnail';
import VideoModal from '../../../components/VideoModal/VideoModal';


const SuggestedCourses = ({navigation, dispatch}) => {
  //variables
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={styles.container}>
        <MyHeader Title="Suggested Courses" isBackButton />
        <ScrollView
...
export default connect(null, mapDispatchToProps)(SuggestedCourses);
